...
{ 
  ...
  # Create a PetaLinux application named linux_fmc_loopback_test.
  petalinux-create --type apps --name linux_fmc_loopback_test --enable

  # Copy the linux_fmc_loopback_test application information over to the 
  # linux_fmc_loopback_test application folder.
  cp -rf ${START_FOLDER}/${PETALINUX_APPS_FOLDER}/linux_fmc_loopback_test/* \
  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/components/apps/linux_fmc_loopback_test

  # Create a PetaLinux application named linux_hdmi_test.
  petalinux-create --type apps --name linux_hdmi_test --enable

  # Copy the linux_hdmi_test application information over to the 
  # linux_hdmi_test application folder.
  cp -rf ${START_FOLDER}/${PETALINUX_APPS_FOLDER}/linux_hdmi_test/* \
  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/components/apps/linux_hdmi_test

  # Create a PetaLinux application named linux_idt8t49n242_test.
  petalinux-create --type apps --name linux_idt8t49n242_test --enable

  # Copy the linux_idt8t49n242_test application information over to the 
  # linux_idt8t49n242_test application folder.
  cp -rf ${START_FOLDER}/${PETALINUX_APPS_FOLDER}/linux_idt8t49n242_test/* \
  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/components/apps/linux_idt8t49n242_test

  # Create a PetaLinux application named linux_iic_eeprom_test.
  petalinux-create --type apps --name linux_iic_eeprom_test --enable

  # Copy the linux_iic_eeprom_test application information over to the 
  # linux_iic_eeprom_test application folder.
  cp -rf ${START_FOLDER}/${PETALINUX_APPS_FOLDER}/linux_iic_eeprom_test/* \
  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/components/apps/linux_iic_eeprom_test

  # Create a PetaLinux application named linux_iic_rtc_test.
  petalinux-create --type apps --name linux_iic_rtc_test --enable

  # Copy the linux_iic_rtc_test application information over to the 
  # linux_iic_rtc_test application folder.
  cp -rf ${START_FOLDER}/${PETALINUX_APPS_FOLDER}/linux_iic_rtc_test/* \
  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/components/apps/linux_iic_rtc_test

  # Create a PetaLinux application named linux_mac_eeprom_test.
  petalinux-create --type apps --name linux_mac_eeprom_test --enable

  # Copy the linux_mac_eeprom_test application information over to the 
  # linux_mac_eeprom_test application folder.
  cp -rf ${START_FOLDER}/${PETALINUX_APPS_FOLDER}/linux_mac_eeprom_test/* \
  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/components/apps/linux_mac_eeprom_test
  ...
  # Create a PetaLinux application named pz_fmc2_factest.
  petalinux-create --type apps --name pz_fmc2_factest --enable

  # Copy the pz_fmc2_factest folder over to the the pz_fmc2_factest application
  # folder.
  cp -rf ${START_FOLDER}/${PETALINUX_APPS_FOLDER}/pz_fmc2_factest/* \
  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/components/apps/pz_fmc2_factest/
  ...
  echo " "
  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/rootfs/config.PZ7020_FMC2_FACTEST \
...
#  ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}/subsystems/linux/configs/device-tree/
  ...
  echo " "
  cp -rf ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/kernel/config.PZ7020_FMC2_FACTEST \
